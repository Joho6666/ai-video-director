...
export const supplementsSchema=z.array(z.object({id:z.enum(['V1','V2','V3']),structure:structureSchema,product_showcase:z.array(z.object({feature:z.string().min(1),action:z.string().min(1),camera_focus:z.string().min(1),evidence:z.string().min(1)})).min(1)})).length(3);
