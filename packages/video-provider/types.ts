...
export type GenerationStatus='PENDING'|'SUBMITTED'|'PROCESSING'|'COMPLETED'|'FAILED';
...
export type GenerationTask={id:string;variantId:'V1'|'V2'|'V3';provider:ProviderName;model:string;task_id?:string;status:GenerationStatus;created_at:string;updated_at:string;submission_started_at?:string;result_url?:string;error?:string;request:VideoGenerationRequest};
